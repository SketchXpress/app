  ...
  return (
    <div className={styles.onboardingContainer}>
      ...
      <div className={styles.centerContent}>
        ...
        <p className={styles.subTagline}>Where messy lines become masterpieces!</p>
      </div>
      ...
      <div className={styles.aiEnhanceHint}>
        ...
        <p className={styles.aiEnhanceText}>Click &quot;AI Enhance&quot; to boost your sketch!</p>
      </div>
      ...
      <div className={styles.leftSidebarSingleHint}>
        <div className={styles.leftArrow}>
          <svg viewBox="0 0 78 38" fill="none">
            <path d="M77 1c-2 14-11.973 31.833-24 35-12.016 3.167-35-6-43.5-9.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round"></path>
            <path fillRule="evenodd" clipRule="evenodd" d="M1 24.165l16.309-2.132-4.258 13.27L1 24.165z" fill="currentColor"></path>
          </svg>
        </div>
