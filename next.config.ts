...
const nextConfig: NextConfig = {
  ...
  async headers() {
    return [
      ...
      {
        source: "/manifests/manifest.webmanifest",
        headers: [
          {
            key: "Content-Type",
